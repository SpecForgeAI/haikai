...
const BASELINE = new Set<string>([
  'src/routes/chatV2.ts',
  'src/services/architectureContextBuilder.ts',
  'src/services/architectureModelClient.ts',
  'src/services/dbChangeConsumerResolver.ts',
  'src/services/dbMigrationPack/inputs.ts',
  'src/services/dbMigrationPack/types.ts',
  'src/services/discovery/resolveBulkActionSet.ts',
  'src/services/discovery/reviewModelWire.ts',
  'src/services/discoveryReviewConversation/agendaSequencer.ts',
  'src/services/effectMapBackfill.ts',
]);
