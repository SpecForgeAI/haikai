...
const BASELINE = new Set<string>([
  'src/services/anchorEntitiesService.ts',
  'src/services/architectureBaselineService.ts',
  'src/services/candidateSaveBackService.ts',
  'src/services/endpointEffectApplyService.ts',
  // Write owner for foundation scope tags (Spec 1) — legitimately touches
  // the raw collection to SET migration_scope.
  'src/services/foundationDecisionApplyService.ts',
  'src/services/gapMetadataApplyService.ts',
  'src/services/userJourneysService.ts',
  'src/services/usersInteractionsService.ts',
  'src/types/saveArchitectureBaseline.ts',
