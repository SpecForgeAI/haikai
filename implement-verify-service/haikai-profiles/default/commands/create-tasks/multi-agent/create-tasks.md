...
- `haikai/specs/[this-spec]/spec.md` (if present)
- `haikai/specs/[this-spec]/planning/requirements.md` (if present)
- `haikai/specs/[this-spec]/planning/visuals/` and its' contents (if present)
...
✅ Tasks list created: `haikai/specs/[this-spec]/tasks.md`
