The final part of our product planning process is to document this product's tech stack in `haikai/product/tech-stack.md`.  Follow these instructions to do so:
...
```
✅ I have documented the product's tech stack at `haikai/product/tech-stack.md`.
