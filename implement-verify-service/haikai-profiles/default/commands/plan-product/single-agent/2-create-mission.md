Now that you've gathered information about this product, use that info to create the mission document in `haikai/product/mission.md` by following these instructions:
...
```
✅ I have documented the product mission at `haikai/product/mission.md`.
