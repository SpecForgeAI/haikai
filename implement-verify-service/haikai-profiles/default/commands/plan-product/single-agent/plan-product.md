...
{{PHASE 1: @haikai/commands/plan-product/1-product-concept.md}}

{{PHASE 2: @haikai/commands/plan-product/2-create-mission.md}}

{{PHASE 3: @haikai/commands/plan-product/3-create-roadmap.md}}

{{PHASE 4: @haikai/commands/plan-product/4-create-tech-stack.md}}
