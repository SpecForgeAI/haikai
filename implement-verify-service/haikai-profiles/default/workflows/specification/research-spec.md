...
1. **Read Product Mission**: Load `haikai/product/mission.md` to understand:
...
2. **Read Product Roadmap**: Load `haikai/product/roadmap.md` to understand:
...
3. **Read Product Tech Stack**: Load `haikai/product/tech-stack.md` to understand:
...
**Answer:** [User's full answer — VERBATIM. Preserve every sentence and clause. Do NOT shorten to "Yes" / "No" / first word, even if the answer starts with one of those. If the user wrote "Yes, X — and not Y", record the whole thing.]

**Q2:** [Second question asked]
**Answer:** [User's full answer — VERBATIM, as above.]

[Continue for all questions. Each `**Answer:**` line MUST contain the user's complete response, not a summary or first-word extraction.]
...
- **Save user's exact answers verbatim** — never collapse to "Yes" / "No" / first word, never substitute a paraphrase. If the user wrote three sentences, write three sentences. The `**Answer:**` field must contain the user's complete response, character for character.
