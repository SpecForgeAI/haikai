...
1. Check `@haikai/product/roadmap.md` to find the next feature in the roadmap.
...
# Do NOT create specs under haikai-profiles or any --add-dir path.
PROJECT_ROOT="$(pwd)"
SPEC_PATH="$PROJECT_ROOT/haikai/specs/$DATED_SPEC_NAME"
