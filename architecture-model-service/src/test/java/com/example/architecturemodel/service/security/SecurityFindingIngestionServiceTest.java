 ...
 * dashboard, 2026-07-19, Spec 1 of 3): ingestion (snapshot-list lifecycle,
 * keep-all dedup, world-fact stubs, M:N joins), the one-flattening-point
 * register (filters + column set + live application names), the Overview
 * rollup (per-application severity counts + Not-matched bucket), CVE
...
class SecurityFindingIngestionServiceTest {
    ...
    private static IngestSecurityFindingRowDto row(String linkingValue,
        ...
        return new IngestSecurityFindingRowDto(
            linkingValue, applicationId, matchStatus, severity, title,
    ...
    @Test
    @DisplayName("ingest persists findings + M:N joins, resolves attribution, creates pending world-fact stubs, and reports no-silent-drop counts")
    ...
    void snapshotListLifecycle() {
        ...
        SecurityRegisterResponse register = registerService.register(
            projectId, architectureId, null, null, null, null, null, null, 0, 50);
    ...
    void registerFlatteningAndParameterization() {
        ...
        SecurityRegisterResponse all = registerService.register(
            projectId, architectureId, null, null, null, null, null, null, 0, 50);
        ...
        SecurityRegisterResponse unmatchedOnly = registerService.register(
            projectId, architectureId, null, null, "unmatched", null, null, null, 0, 50);
        assertThat(unmatchedOnly.total()).isEqualTo(1);
        assertThat(unmatchedOnly.data().get(0).get("application_name")).isNull();

        SecurityRegisterResponse byApp = registerService.register(
            projectId, architectureId, null, APP_HIFI, null, null, null, null, 0, 50);
        assertThat(byApp.total()).isEqualTo(1);
        assertThat(byApp.data().get(0).get("linking_value")).isEqualTo("HiFi");

        SecurityRegisterResponse narrow = registerService.register(
            projectId, architectureId, null, null, null, null, null,
            List.of("finding_id", "severity_reported", "no_such_column"), 0, 50);
    ...
    void enrichmentGrace() {
        ...
        SecurityRegisterResponse before = registerService.register(
            projectId, architectureId, null, APP_MRX, null, null, null,
        ...
        SecurityRegisterResponse after = registerService.register(
            projectId, architectureId, null, APP_MRX, null, null, null,
            List.of("severity_reported", "cve_severity_official", "cve_enrichment_status"),
            0, 50);
